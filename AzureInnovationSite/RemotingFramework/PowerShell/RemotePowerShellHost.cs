...
namespace RemotingFramework.PowerShell
{
    ...
    /// </summary>
    /// <seealso cref="PSHost" />
    public class RemotePowerShellHost : PSHost
    {
        ...
        /// </summary>
        public override PSHostUserInterface UI { get; } = new RemotePowerShellHostUserInterface();
        ...
        /// cref="NotImplementedException" /> exception when it receives this call.
        /// </exception>
        /// <exception cref="RuntimeException">
        /// The host can throw this exception when an error occurs while a command is
        /// running.
