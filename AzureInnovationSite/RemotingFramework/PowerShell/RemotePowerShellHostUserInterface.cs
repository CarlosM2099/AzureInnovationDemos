...
namespace RemotingFramework.PowerShell
{
    ...
    /// </summary>
    /// <seealso cref="PSHost" />
    public class RemotePowerShellHostUserInterface : PSHostUserInterface
    {
        /// <summary>
        ...
        /// </summary>
        public Action<PowerShellWriteLevel, ConsoleColor?, ConsoleColor?, string> WriteCallback { get; set; }
        ...
        private static string Stringify(object input)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemotePowerShellHostUserInterface"
        /// /> class.
        /// </summary>
        public RemotePowerShellHostUserInterface()
        {
        ...
        )
        {
            ...
            // no idea how this is happening, but it is...
        ...
        /// A collection of <see cref="FieldDescription" /> objects that contains the user
        /// input.
        /// </param>
        /// <returns>
        /// A dictionary of types <see cref="string" /> and <see cref="PSObject" /> that
        ...
        /// <param name="choices">
        /// A collection of <see cref="ChoiceDescription" /> objects that describe each
        /// choice.
        /// </param>
        ...
        /// A bitwise combination of the <see cref="PSCredentialTypes" /> enumeration
        /// values that identify the types of credentials that can be returned.
        /// </param>
        /// <param name="options">
        /// A bitwise combination of the <see cref="PSCredentialUIOptions" /> enumeration
        ...
        {
            WriteToLog(PowerShellWriteLevel.Standard, null, null, value);
        }
        ...
        {
            WriteToLog(PowerShellWriteLevel.Standard, foregroundColor, backgroundColor, value);
        }
        ...
        {
            WriteToLog(PowerShellWriteLevel.Debug, null, null, (message ?? string.Empty) + Environment.NewLine);
        }
        ...
        {
            WriteToLog(PowerShellWriteLevel.Error, null, null, (message ?? string.Empty) + Environment.NewLine);
        }
        ...
        {
            WriteToLog(PowerShellWriteLevel.Standard, null, null, (value ?? string.Empty) + Environment.NewLine);
        }
        ...
        {
            Debug.WriteLine($"[PROGRESS(Id: {sourceId})] " + Stringify(record));
        ...
        {
            WriteToLog(PowerShellWriteLevel.Verbose, null, null, (message ?? string.Empty) + Environment.NewLine);
        }
        ...
        {
            WriteToLog(PowerShellWriteLevel.Warning, null, null, (message ?? string.Empty) + Environment.NewLine);
        }
    }
}